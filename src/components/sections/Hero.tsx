import { PhraseCollage } from "@/components/interactive/PhraseCollage";
import { Magnetic } from "@/components/ui/Magnetic";
import { OpenChatButton } from "@/components/ui/OpenChatButton";

export function Hero() {
  return (
    <section id="hero" className="relative z-10 overflow-hidden bg-ink">
      <PhraseCollage scrim="strong" />
